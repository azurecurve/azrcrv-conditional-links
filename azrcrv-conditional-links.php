...
const PLUGIN_NAME       = 'Conditional Links';
const PLUGIN_SHORT_SLUG = 'conditional-links';
const PLUGIN_SLUG       = 'azrcrv-' . PLUGIN_SHORT_SLUG;
const PLUGIN_HYPHEN     = 'azrcrv-cl';
const PLUGIN_UNDERSCORE = 'azrcrv_cl';
...
/**
 * Include setup of actions, filters and shortcodes.
 */
