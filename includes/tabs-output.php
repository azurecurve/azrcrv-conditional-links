...
<form method="post" action="admin-post.php">
	...
	<input type="submit" name="btn_save" value="<?php esc_html_e( 'Save Settings', 'azrcrv-cl' ); ?>" class="button-primary"/>
</form>
<?php
/*
...
<div class='azrcrv-donate'>
	<?php
		printf( esc_html__( 'Support %s', 'azrcrv-cl' ), esc_html( DEVELOPER_NAME ) );
	?>
