...
$tab_plugins_label = esc_html__( 'Other Plugins', 'azrcrv-cl' );
$tab_plugins       = '
<table class="form-table azrcrv-settings">
	...
	<tr>
		...
		<td scope="row" colspan=2>
			...
			<p>' .
				sprintf( esc_html__( '%1$s was one of the first plugin developers to start developing for ClassicPress; all plugins are available from %2$s and are integrated with the %3$s plugin for fully integrated, no hassle, updates.', 'azrcrv-cl' ), '<strong>' . DEVELOPER_SHORTNAME . '</strong>', DEVELOPER_LINK, '<a href="https://directory.classicpress.net/plugins/update-manager/">Update Manager</a>' )
			. '</p>
			<p>' .
				sprintf( esc_html__( 'Other plugins available from %s, which you are not using, are:', 'azrcrv-cl' ), '<strong>' . DEVELOPER_NAME . '</strong>' )
			. '</p>
