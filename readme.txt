...
Download link:	https://github.com/azurecurve/azrcrv-conditional-links/releases/download/v1.1.0/azrcrv-conditional-links.zip
...
### [Version 1.1.1](https://github.com/azurecurve/azrcrv-conditional-links/tree/v1.1.1)
 * Fix bug with incorrect language load text domain.

### [Version 1.1.0](https://github.com/azurecurve/azrcrv-conditional-links/tree/v1.1.0)
 * Add integration with Update Manager for automatic updates.
 * Fix issue with display of azurecurve menu.
 * Change settings page heading.
 * Add load_plugin_textdomain to handle translations.

### [Version 1.0.1(https://github.com/azurecurve/azrcrv-conditional-links/tree/v1.0.1)
 * Update azurecurve menu for easier maintenance.
 * Move require of azurecurve menu below security check.
 * Localization fixes.

### [Version 1.0.0](https://github.com/azurecurve/azrcrv-conditional-links/tree/v1.0.0)
