 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_cl')){
	function azrcrv_create_plugin_menu_cl(){
		azrcrv_create_plugin_menu_table_cl();
		azrcrv_populate_plugin_menu_table_cl();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_cl')){
	function azrcrv_populate_plugin_menu_table_cl(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_cl')){
	function azrcrv_create_plugin_menu_table_cl(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
